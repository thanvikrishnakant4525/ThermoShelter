    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="grid grid-cols-2 gap-2">
              {PRESET_EXAMPLES.map((ex) => {
                ...
                return (
                  ...
                  >
                    <div className="font-semibold text-[11px]">{ex.label.split(',')[0]}</div>
                    <div className="text-[10px] text-slate-500 font-normal">{ex.tag}</div>
                  </button>
                );
              })}
            </div>
        ...
        <div className="lg:col-span-7 flex flex-col gap-4">
          <div className="relative bg-slate-100 rounded-xl overflow-hidden border border-slate-300 h-[400px] shadow-xs">
            <div ref={mapContainerRef} className="w-full h-full z-10" />

            <div className="absolute top-3 right-3 z-20 bg-white/95 backdrop-blur-xs border border-slate-200 px-3 py-1.5 rounded-md shadow-xs text-[11px] text-slate-700 flex items-center gap-1.5">
              <Navigation className="w-3.5 h-3.5 text-blue-700" />
              <span>Click or drag pin to choose exact site</span>
            </div>
          </div>
          ...
          <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-xs flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-[11px] text-slate-500 font-semibold uppercase tracking-wider">Selected Location</div>
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                className="w-20 px-2 py-1 text-xs border border-slate-300 rounded bg-slate-50 text-slate-700 font-mono"
                title="Latitude"
              />
              <input
                type="number"
              ...
              <button
                ...
                className="px-2.5 py-1 text-xs font-semibold bg-slate-100 hover:bg-slate-200 border border-slate-300 rounded text-slate-700 transition-colors"
              >
                Set
              </button>
            </div>
          ...
          <div className="p-4 bg-slate-900 rounded-xl text-white flex flex-col sm:flex-row items-center justify-between gap-4 shadow-sm">
            <div>
              <div className="text-xs text-slate-300 font-medium">Ready to Analyze</div>
            ...
            <button
              ...
              disabled={isLoading}
              className="w-full sm:w-auto px-6 py-2.5 bg-blue-600 hover:bg-blue-500 text-white rounded-lg text-xs font-bold flex items-center justify-center gap-2 shadow-sm transition-all cursor-pointer"
            >
