      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-2xl max-w-4xl w-full max-h-[85vh] flex flex-col overflow-hidden">
        ...
        <div className="p-5 border-b border-slate-200 flex items-center justify-between bg-slate-50">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h2 className="text-base font-bold text-slate-900">Scientific Building Materials Catalog</h2>
              <p className="text-xs text-slate-500">Verified thermal properties derived from ASHRAE & NBC 2016 standards</p>
            </div>
          </div>
          <button
            onClick={onClose}
